...
def groq_chat(prompt, temperature=0.1):
    if not GROQ_API_KEY:
        raise RuntimeError(
...
"""
    ...
    answer = groq_chat(prompt, temperature=0.0)
...
"""
    ...
    return groq_chat(prompt, temperature=0.1)
...
"""
    ...
    raw = groq_chat(prompt, temperature=0.0)
